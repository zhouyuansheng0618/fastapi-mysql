...
class Settings(BaseSettings):
    ...
    MYSQL_PASSWORD: str = os.getenv("MYSQL_PASSWORD", "zhouys618!")
    MYSQL_HOST: Union[AnyHttpUrl, IPvAnyAddress] = os.getenv("MYSQL_HOST", "114.132.40.250")
    MYSQL_DATABASE: str = os.getenv("MYSQL_DB", "blog")
    ...
    # redis配置
    REDIS_HOST: str = os.getenv("REDIS_HOST", "114.132.40.250")
    REDIS_PASSWORD: str = os.getenv("REDIS_PASSWORD", "zhouys618")
    REDIS_DB: int = 1
    REDIS_PORT: int = 6379
